...
from .views import CreateTicketView, CreateMessageView, ListTicketView, TicketMessagesView, TicketStatusUpdateView
...
urlpatterns = [
    ...
    path("<int:ticket_id>/status/", TicketStatusUpdateView.as_view())
]